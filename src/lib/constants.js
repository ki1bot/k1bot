...
export const FALLBACK_PROJECTS = [
  ...
  },
  {
    ...
    description:
      "Aplikasi web untuk membuat, mengedit, dan membagikan catatan dengan sistem autentikasi, collaborator, role akses, autosave melalui API Route Next.js, serta penyimpanan data menggunakan MongoDB.",
    ...
    features: [
      ...
      "Autentikasi pengguna dengan login dan register",
  ...
  },
  {
    ...
    description:
      "Platform pembelajaran debugging pemrograman berbasis web yang menyediakan 24 tantangan JavaScript, PHP, dan SQL. Pengguna dapat mencari lokasi bug, memperbaiki kode melalui CodeMirror, menjelaskan penyebab kesalahan, menggunakan hint, memperoleh skor dan poin, melihat riwayat pengerjaan, serta bersaing melalui leaderboard. Aplikasi juga menyediakan dashboard administrator untuk mengelola tantangan, kategori, tingkat kesulitan, solusi, hint, pengguna, dan submission.",
    ...
    features: [
      "Registrasi, login, logout, dan pembagian akses berdasarkan role user dan administrator",
      "Menyediakan 24 tantangan debugging untuk JavaScript, PHP, dan SQL dengan tingkat kesulitan mudah, menengah, dan sulit",
      "Pencarian dan filter tantangan berdasarkan bahasa pemrograman serta tingkat kesulitan",
      "Penyelesaian tantangan melalui tiga tahap: menentukan baris yang salah, memperbaiki kode, dan menjelaskan penyebab bug",
      "Code editor berbasis CodeMirror dengan dukungan syntax highlighting berbagai bahasa pemrograman",
      "Sistem penilaian berdasarkan ketepatan lokasi bug, perbaikan kode, dan penjelasan penyebab kesalahan",
      "Hint bertahap dengan penalti skor serta pembahasan, solusi utama, dan alternatif solusi setelah tantangan selesai",
      "Riwayat pengerjaan, total poin, progres tantangan, dan leaderboard pengguna",
      "Dashboard administrator untuk mengelola kategori, tingkat kesulitan, tantangan, hint, solusi, pengguna, dan submission",
    ],
    tech_stack: [
      "Laravel 13",
      "React 18",
